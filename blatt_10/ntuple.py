...
variablesToNTuple("D*+:sig",['InvM','daughter(0,p)','Q', 'daughter(0,InvM)'],filename="results.root")
applyCuts('D*+:sig', ' 0.004 < Q < 0.01')
variablesToNTuple("D*+:sig",['Q', 'daughter(0,InvM)'],filename="resultswithqcut.root")
