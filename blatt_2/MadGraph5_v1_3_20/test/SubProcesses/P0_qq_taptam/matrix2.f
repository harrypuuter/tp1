...
C     
C     Process: d d~ > ta+ ta- HIG=1 HIW=1 WEIGHTED=4
C     Process: s s~ > ta+ ta- HIG=1 HIW=1 WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1_3(W(1,1),W(1,2),GC_2,ZERO, ZERO, W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,3),W(1,4),W(1,5),GC_4,AMP(1))
      CALL FFV2_3_3(W(1,1),W(1,2),GC_27,GC_29,MZ, WZ, W(1,6))
C     Amplitude(s) for diagram number 2
      CALL FFV2_4_0(W(1,3),W(1,4),W(1,6),GC_27,GC_30,AMP(2))
      JAMP(1)=+AMP(1)+AMP(2)
      MATRIX2 = 0.D0
      DO I = 1, NCOLOR
        ZTEMP = (0.D0,0.D0)
