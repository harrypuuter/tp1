...
C     
C     Process: u u~ > ta+ ta- HIG=1 HIW=1 WEIGHTED=4
C     Process: c c~ > ta+ ta- HIG=1 HIW=1 WEIGHTED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV1_3(W(1,1),W(1,2),GC_3,ZERO, ZERO, W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,3),W(1,4),W(1,5),GC_4,AMP(1))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_28,GC_29,MZ, WZ, W(1,6))
