...
C     ----------
      ...
      CALL FFV1_3(W(1,1),W(1,2),GC_2,ZERO, ZERO, W(1,9))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,9),W(1,8),W(1,5),GC_25,AMP(1))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_22,GC_23,MZ, WZ, W(1,10))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,8),W(1,5),W(1,10),GC_7,AMP(2))
      CALL FFV2_2(W(1,1),W(1,5),GC_16,ZERO, ZERO, W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,11),W(1,2),W(1,8),GC_16,AMP(3))
