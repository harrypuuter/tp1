...
c    |      |
c    |      |---> pgs_kt_jets                       jet reconstruction with kt algorithm
c    |      |
...
c -----------------------------------------------------------------
      ...
      if(pt1.gt.pt2) then
        pgs_kt_dist = pt2**2 * ((eta1-eta2)**2 + delphi**2)/conesize**2
      else
        pgs_kt_dist = pt1**2 * ((eta1-eta2)**2 + delphi**2)/conesize**2
      endif
