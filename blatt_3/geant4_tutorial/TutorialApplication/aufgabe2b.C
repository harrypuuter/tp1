...
{ 
  ...
  //gROOT->LoadMacro("../geant4_vmc/examples/macro/g4libs_old.C");
 ...
 ////////////////////////////////////////////////////////////////////////////////
  ...
  TH1F* hwidth  = new TH1F("hwidth","width of the shower",200,0.0,15);
  TH1F* hlength = new TH1F("hlength","length of the shower",200,0.0,17.5);
